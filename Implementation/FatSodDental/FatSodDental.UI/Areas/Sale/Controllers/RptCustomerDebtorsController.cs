...
{
    public class RptCustomerDebtorsController : BaseController
    {
        //Current Controller and current page
        private const string CONTROLLER_NAME = "Sale/RptCustomerDebtors";
        ...
        public void Reset()
        {
            this.GetCmp<FormPanel>("RptRptCustomerDebtors").Reset(true);
            this.PartialReset();
        }
        ...
        private void chargeSolde()
        {
            ...
            //var lstAccountOperations = db.AccountOperations.Where(ao => ao.BranchID == BranchID && ao.DeviseID == DeviseID && ao.DateOperation <= Edate && ao.AccountTierID != null).ToList(); ;
            ...
            foreach (var debtor in lstAccountOperations.ToList())
            {
                Totaldebit = Totaldebit + debtor.Solde;
            }
        ...
        public ActionResult ShowGeneric()
        {
            ...
            this.Session["RepTitle"] = Resources.RptCustomerDebtorsTitle;
            ...
            return RedirectToAction("ShowGenericRpt", "RptCustomerDebtors");
        }
    }
}