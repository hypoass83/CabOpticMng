...
namespace FatSodDental.UI.Areas.CashRegister.Controllers
{
    ...
    public class SaleController : BaseController
    {
       ...
       // [DirectMethod]
        ...
        [HttpPost]
        private ActionResult ResetLensFrame()
        {
            SimleResetFrame();
            SimpleResetLens();
            return this.Direct();
        }
        private void SimleResetFrame()
        {
            this.GetCmp<ComboBox>("ProductID").Clear();
            this.GetCmp<NumberField>("StockQuantity").Value = 0;
            this.GetCmp<TextField>("marque").Value = "";
            this.GetCmp<TextField>("reference").Value = "";
            this.GetCmp<NumberField>("FramePrice").Value = "";
