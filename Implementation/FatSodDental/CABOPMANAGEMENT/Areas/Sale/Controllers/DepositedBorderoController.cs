...
namespace CABOPMANAGEMENT.Areas.Sale.Controllers
{
    ...
    public class DepositedBorderoController : BaseController
    {
        //Current Controller and current page
        private const string CONTROLLER_NAME = "Sale/DepositedBordero";
        ...
        public DepositedBorderoController(
            ...
            var model = new
            {
                data = from c in lstCustOrder.OrderBy(c => c.Assureur.Name).ThenBy(c => c.CustomerOrderDate)
                       select new
                       {
                           ...
                           CodeBorderoDepot = (db.BorderoDepots.SingleOrDefault(b =>b.BorderoDepotID == c.BorderoDepotID).CodeBorderoDepot),
                           BorderoDepotDate = (db.BorderoDepots.SingleOrDefault(b =>b.BorderoDepotID == c.BorderoDepotID).BorderoDepotDate).ToString("yyyy-MM-dd"),
        ...
        public JsonResult DisplayCodeBordero(int BranchID, DateTime BeginDate, DateTime EndDate, int AssuranceID, string CompanyID="0", int LieuxdeDepotBorderoID=0, bool isValidated = false)
        {
            ...
            double EstimatedAmount = (lstCustOrder.Count==0) ?0 : lstCustOrder.Sum(c => c.Plafond);
