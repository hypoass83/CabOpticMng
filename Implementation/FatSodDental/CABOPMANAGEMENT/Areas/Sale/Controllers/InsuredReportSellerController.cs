...
namespace CABOPMANAGEMENT.Areas.Sale.Controllers
{
    ...
    public class InsuredReportSellerController : BaseController
    {
        private IBusinessDay _busDayRepo;


        public InsuredReportSellerController(
        ...
        public JsonResult chargeSolde(DateTime Begindate, DateTime EndDate, int SellerID = 0)
        {
            ...
            {
                listBillInsuredOp = db.V_Summary_Insured_Bill.Where(co => co.SellerID.Value == SellerID && (co.CustomerOrderDate >= Begindate && co.CustomerOrderDate <= EndDate)).ToList();
            }
        ...
        public JsonResult ModelBillInsure_Detail(DateTime Begindate, DateTime EndDate, int SellerID = 0)
        {
            ...
            {
                listBillInsuredOp = db.V_Detail_Insured_Bill.Where(co => co.SellerID.Value == SellerID && (co.CustomerOrderDate >= Begindate && co.CustomerOrderDate <= EndDate)).ToList();
            }
