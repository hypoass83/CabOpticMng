...
namespace CABOPMANAGEMENT.Areas.CRM.Controllers
{
    ...
    public class SalesReportController : BaseController
    {
        ...
        public JsonResult chargeSolde(DateTime Begindate, DateTime EndDate, int MarketerID = 0)
        {
            ...
            {
                listBillInsuredOp = db.V_Summary_Sales.Where(co => co.MarketerID.Value == MarketerID && (co.SaleDate >= Begindate && co.SaleDate <= EndDate)).ToList();
            }
        ...
        public JsonResult ModelBillInsure_Detail(DateTime Begindate, DateTime EndDate, int MarketerID = 0)
        {
            ...
            {
                listBillInsuredOp = db.V_Detail_Sales.Where(co => co.MarketerID.Value == MarketerID && (co.SaleDate >= Begindate && co.SaleDate <= EndDate)).ToList();
            }
