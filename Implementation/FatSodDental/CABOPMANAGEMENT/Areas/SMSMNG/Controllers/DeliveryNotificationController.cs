...
namespace CABOPMANAGEMENT.Areas.SMSMNG.Controllers
{
    ...
    public class DeliveryNotificationController : BaseNotificationController
    {
        private IBusinessDay _busDayRepo;
        public DeliveryNotificationController(
            ...
            var res = (from csb in db.CumulSaleAndBills
                       ...
                       select new
                       {
                           ...
                           CustomerPhone = s.Customer != null ?
                            (s.Customer.Adress.AdressPhoneNumber != null ? s.Customer.Adress.AdressPhoneNumber : s.Customer.Adress.AdressCellNumber)
                           : 
        ...
        public string GetPhoneNumber(Adress adress)
        {
            string phoneNumber = "";
            phoneNumber = adress.AdressPhoneNumber;
            if (phoneNumber == null)
            {
                phoneNumber = adress.AdressCellNumber;
            }
            return phoneNumber;
        }
    }
