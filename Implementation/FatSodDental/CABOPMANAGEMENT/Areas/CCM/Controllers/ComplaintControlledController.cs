...
{
    public class ComplaintControlledController : BaseController
    {
        ...
        public ComplaintControlledController(
        ...
        public List<CustomerComplaint> getGeneralSales(int branchId, DateTime startDate, DateTime endDate, DateTime operationDate, int profileId)
        {
            ...
            List<CustomerComplaint> complaints = db.CustomerComplaints.Where(cpt => cpt.ControlledDate == null &&
                                                 cpt.ResolvedDate >= startDate && cpt.ResolvedDate <= endDate).ToList();
            ...
            complaints.ForEach(complaint =>
            {
                ...
                CustomerComplaint customerComplaint = new CustomerComplaint
                {
                    ...
                    Resolver = complaint.ComplaintResolver.UserFullName,
