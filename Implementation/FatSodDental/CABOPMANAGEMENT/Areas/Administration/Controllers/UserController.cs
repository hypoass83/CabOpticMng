...
namespace CABOPMANAGEMENT.Areas.Administration.Controllers
{
    ...
    public class UserController : BaseController
    {
        ...
        public JsonResult populateRegion(string countryId)
        {
            ...
            var Regions = (from s in db.Regions where s.CountryID == _countryId
        ...
        public JsonResult populateTown(string regionId)
        {
            ...
            var Towns = (from s in db.Towns where s.RegionID == _regionId
        ...
        **/
                ...
                LoadComponent.UsersForStore(CurrentUser).ForEach(u =>
                {
                    model.Add(
                            new User
                            {
                                ...
                                Adress=u.Adress,
                                //AdressEmail = u.Adress.AdressEmail,
        ...
        //[HttpPost]
        public JsonResult AddUser(Adress adress, User user, string[] Branch, int IsConnected,int IsMarketer,int IsSeller, int SexID , HttpPostedFileBase UploadImage, int? ProfileID, int UserAccountState)
        {
            bool status = false;
            string Message = "";
            try
            {
                ...
                user.IsMarketer = Convert.ToBoolean(IsMarketer);
                user.IsSeller = Convert.ToBoolean(IsSeller);
        ...
        public JsonResult Edit(int id)
        {
            ...
            _UserList.Add(new
            {
                ...
                AdressID=userEntity.Adress.AdressID,
                IsConnected = Convert.ToInt16(userEntity.IsConnected),
                IsMarketer = Convert.ToInt16(userEntity.IsMarketer),
                IsSeller = Convert.ToInt16(userEntity.IsSeller),
