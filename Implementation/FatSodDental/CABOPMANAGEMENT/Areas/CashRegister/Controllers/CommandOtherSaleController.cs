...
namespace CABOPMANAGEMENT.Areas.CashRegister.Controllers
{
    ...
    public class CommandOtherSaleController : BaseController
    {
        //Current Controller and current page
        private const string CONTROLLER_NAME = "CashRegister/CommandOtherSale";
        ...
        //Construcitor
        public CommandOtherSaleController(
        ...
        public JsonResult AddAuthoriseSale(AuthoriseSale currentSale,  string heureVente, string RateReduction, double TVA = 0)
        {
            ...
            try
            {
                ...
                currentSale.IsSpecialOrder = true;
                currentSale.IsOtherSale = true;

                currentSale.DateOfBirth = new DateTime (1900,1,1); 
        ...
        public JsonResult GetProductCategory()
        {
            ...
            List<Category> categories = LoadComponent.GetAllFrameGenericCategories();
