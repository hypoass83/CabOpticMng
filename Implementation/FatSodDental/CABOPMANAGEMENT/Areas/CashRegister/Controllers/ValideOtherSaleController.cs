...
namespace CABOPMANAGEMENT.Areas.CashRegister.Controllers
{
    ...
    public class ValideOtherSaleController : BaseController
    {
        //Current Controller and current page
        private const string CONTROLLER_NAME = "CashRegister/ValideOtherSale";
        ...
        public ValideOtherSaleController(
        ...
        public JsonResult ModelSaleValidate()
        {
            ...
            var model = new
            {
                data = from c in db.AuthoriseSales.Where(c => !c.IsDelivered && !c.IsDilatation && c.IsSpecialOrder).ToList()
                       select
                       new
                       {
        ...
        public JsonResult InitializeCommandFields(int ID)
        {
            ...
            try
            {
                ...
                _CommandList.Add(new
                {
                    ...
                    //Representant = customerOrder.Customer.Name,
