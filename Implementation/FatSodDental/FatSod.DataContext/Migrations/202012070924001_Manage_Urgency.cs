namespace FatSod.DataContext.Migrations
{
    ...
    public partial class Manage_Urgency : DbMigration
    {
        public override void Up()
        {
            AddColumn("dbo.CustomerOrders", "IsUrgent", c => c.Boolean(nullable: false));
            AddColumn("dbo.AuthoriseSales", "IsUrgent", c => c.Boolean(nullable: false));
            AddColumn("dbo.CumulSaleAndBills", "IsUrgent", c => c.Boolean(nullable: false));
        ...
        {
            DropColumn("dbo.CumulSaleAndBills", "IsUrgent");
            DropColumn("dbo.AuthoriseSales", "IsUrgent");
            DropColumn("dbo.CustomerOrders", "IsUrgent");
