namespace FatSod.DataContext.Migrations
{
    ...
    public partial class add_MntValideBordero_bill : DbMigration
    {
        public override void Up()
        {
            AddColumn("dbo.CustomerOrders", "MntValideBordero", c => c.Double(nullable: false));
            AddColumn("dbo.CustomerOrders", "isMntValideBordero", c => c.Boolean(nullable: false));
        ...
        {
            DropColumn("dbo.CustomerOrders", "isMntValideBordero");
            DropColumn("dbo.CustomerOrders", "MntValideBordero");
