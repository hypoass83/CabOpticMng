namespace FatSod.DataContext.Migrations
{
    ...
    public partial class AddBPCdateAndRelation : DbMigration
    {
        public override void Up()
        {
            AddColumn("dbo.CustomerOrders", "DateBPC", c => c.DateTime());
            AddColumn("dbo.CustomerOrders", "Relation", c => c.String());
                ...
                p => new
                    {
                        ...
                        TreatmentDate = p.DateTime(),
                        Transport = p.Double(),
                        PlafondAssurance = p.Double(),
                        RemiseAssurance = p.Double(),
                        ...
                        DateExpiration = p.DateTime(),
                        DateBPC = p.DateTime(),
                        Relation = p.String(),
                    },
                body:
                    @"INSERT [dbo].[CustomerOrders]([CompteurFacture], [IsUrgent], [CustomerOrderDate], [CustomerDateHours], [VatRate], [RateReduction], [RateDiscount], [Patient], [CustomerOrderNumber], [IsDelivered], [CustomerName], [InsurreName], [PhoneNumber], [PoliceAssurance], [CompanyName], [CustomerID], [AssureurID], [LieuxdeDepotBorderoID], [InsuredCompanyID], [DeviseID], [BranchID], [OperatorID], [Remarque], [MedecinTraitant], [TreatmentDate], [Transport], [PlafondAssurance], [RemiseAssurance], [NumeroBonPriseEnCharge], [VerreAssurance], [MontureAssurance], [Plafond], [TotalMalade], [CustomerValue], [LastCustomerValue], [NumeroFacture], [BillState], [DatailBill], [MntValidate], [GestionnaireID], [SellerID], [ValidateBillDate], [BorderoDepotID], [DeleteReason], [DeleteBillDate], [DeletedByID], [MntValideBordero], [isMntValideBordero], [DateExpiration], [DateBPC], [Relation])
            ...
            AlterStoredProcedure(
                ...
                body:
                    @"UPDATE [dbo].[CustomerOrders]
                      SET [CompteurFacture] = @CompteurFacture, [IsUrgent] = @IsUrgent, [CustomerOrderDate] = @CustomerOrderDate, [CustomerDateHours] = @CustomerDateHours, [VatRate] = @VatRate, [RateReduction] = @RateReduction, [RateDiscount] = @RateDiscount, [Patient] = @Patient, [CustomerOrderNumber] = @CustomerOrderNumber, [IsDelivered] = @IsDelivered, [CustomerName] = @CustomerName, [InsurreName] = @InsurreName, [PhoneNumber] = @PhoneNumber, [PoliceAssurance] = @PoliceAssurance, [CompanyName] = @CompanyName, [CustomerID] = @CustomerID, [AssureurID] = @AssureurID, [LieuxdeDepotBorderoID] = @LieuxdeDepotBorderoID, [InsuredCompanyID] = @InsuredCompanyID, [DeviseID] = @DeviseID, [BranchID] = @BranchID, [OperatorID] = @OperatorID, [Remarque] = @Remarque, [MedecinTraitant] = @MedecinTraitant, [TreatmentDate] = @TreatmentDate, [Transport] = @Transport, [PlafondAssurance] = @PlafondAssurance, [RemiseAssurance] = @RemiseAssurance, [NumeroBonPriseEnCharge] = @NumeroBonPriseEnCharge, [VerreAssurance] = @VerreAssurance, [MontureAssurance] = @MontureAssurance, [Plafond] = @Plafond, [TotalMalade] = @TotalMalade, [CustomerValue] = @CustomerValue, [LastCustomerValue] = @LastCustomerValue, [NumeroFacture] = @NumeroFacture, [BillState] = @BillState, [DatailBill] = @DatailBill, [MntValidate] = @MntValidate, [GestionnaireID] = @GestionnaireID, [SellerID] = @SellerID, [ValidateBillDate] = @ValidateBillDate, [BorderoDepotID] = @BorderoDepotID, [DeleteReason] = @DeleteReason, [DeleteBillDate] = @DeleteBillDate, [DeletedByID] = @DeletedByID, [MntValideBordero] = @MntValideBordero, [isMntValideBordero] = @isMntValideBordero, [DateExpiration] = @DateExpiration, [DateBPC] = @DateBPC, [Relation] = @Relation
