namespace FatSod.DataContext.Migrations
{
    ...
    public partial class AddRxExpireddate : DbMigration
    {
        public override void Up()
        {
            AddColumn("dbo.CustomerOrders", "DateExpiration", c => c.DateTime());
